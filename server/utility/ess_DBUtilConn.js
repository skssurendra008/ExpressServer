...
exports.updateRideDetails = function(Table, queryParam, callback) {
    ...
    // console.log(queryParam.uniqueRideName);
    // let bookingArr = {};
    // bookingArr.username = queryParam.myusername;
    // bookingArr.mobileNumber =  queryParam.mobileNumber,
    // bookingArr.bookedSeats = queryParam.bookedSeats;
    // bookingArr.source = queryParam.source;
    // bookingArr.destination = queryParam.destination;
    // bookingArr.bookingStatus = queryParam.bookingStatus;

    // let updatedDetails = {};
    // updatedDetails['availableSeats'] = queryParam.availableSeats-queryParam.bookedSeats;
    // console.log(updatedDetails);
    let seats = queryParam.availableSeats-queryParam.bookedSeats;
    
    // Table.update({'_id': queryParam.rideId}, updatedDetails, function(err, doc){
    //     callback(err,doc);
    // });
